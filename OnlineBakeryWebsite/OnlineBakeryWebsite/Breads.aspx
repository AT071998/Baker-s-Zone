<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="Breads.aspx.cs" Inherits="OnlineBakeryWebsite.Breads" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <link href="css/Custome.css" rel="stylesheet" />
        ...
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
            ...
            <div class ="form-horizontal ">
                <h2 style="color:black; font-size:30px; text-align:center;">Bread and Buns</h2>
            ...
            <table class="table table-bordered" >
                ...
                <tr>
                    <td class="auto-style2">
                        ...
                        <asp:Label ID="Label5" runat="server" Text="Per Packet"></asp:Label>
                    </td>
                </tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyDB %>" SelectCommand="select * from TableProduct  where PCategoryId=1002 order by  PId  desc"></asp:SqlDataSource>
</asp:Content>
