<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="Bagels.aspx.cs" Inherits="OnlineBakeryWebsite.Bagels" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
       <link href="css/Custome.css" rel="stylesheet" />
        ...
        <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
            ...
            <div class ="form-horizontal ">
                <h2 style="color:black; font-size:30px; text-align:center;">Pastries</h2>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyDB %>" SelectCommand="select * from TableProduct  where PCategoryId=1001 order by  PId  desc"></asp:SqlDataSource>
</asp:Content>