<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageUser.Master" AutoEventWireup="true" CodeBehind="cookies.aspx.cs" Inherits="OnlineBakeryWebsite.cookies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MyDB %>" SelectCommand="select * from TableProduct  where PCategoryId=1004 order by  PId  desc"></asp:SqlDataSource>
